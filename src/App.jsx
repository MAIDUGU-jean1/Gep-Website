          ...
          >
            ...
            >
              <div style={{
                ...
                background: 'rgba(218, 165, 32, 0.12)', borderRadius: '50%'
              }} />
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                <div style={{
                  width: '28px', height: '28px', borderRadius: '50%', flexShrink: 0,
                  background: 'linear-gradient(135deg, var(--primary-color), var(--secondary-color, #daa520))',
                ...
                <p style={{
                  ...
                  🧼 New Program  Enrollments OnGoing
                </p>
              </div>
              <h3 style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', fontWeight: '800', marginBottom: '5px' }}>
              ...
              <p style={{ color: 'var(--text-primary)', fontSize: '0.82rem', lineHeight: '1.5', marginBottom: '10px', opacity: 0.85 }}>
                ...
                <strong style={{ color: 'var(--text-secondary)' }}> Learn. Produce. Succeed.</strong>
              </p>
